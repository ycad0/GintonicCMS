...
<tr>
    ...
    <td class="text-center">
        <span class="text-center ">
            <?php
            echo $this->Html->link('<i class="fa fa-link">&nbsp;</i>&nbsp;', 'javascript:void(0)', ['escape' => false, 'class' => 'getFileLink', 'data-value' => $this->Url->build('/', true) . 'files/uploads/' . $file->filename, 'data-pk' => $file->id]);
