...
if(!empty($album)):
    foreach ($album as $key => $image): ?>
       <div class="col-md-3" style="margin-top: 10px">
            <?php echo $this->Html->image($this->File->getFileUrl($image->file->filename, ''), array('class' => 'img-responsive img-thumbnail', 'id' => 'userphoto', 'style' => 'height:150px;width:255px;'));?>
