<div class="container">
    <div class="row">
        <div class="col-md-12">
            ...
            <?php
            echo $this->Form->create('SubscribePlan', array('url' => array('controller' => 'plans', 'action' => 'createPlans', (isset($title) ? $this->request->params['pass'][0] : '')), 'inputDefaults' => array('div' => 'col-md-12 form-group', 'class' => 'form-control'), 'class' => 'form-horizontal', 'id' => 'PlanAddForm', 'novalidate' => 'novalidate'));
